          ...
          <div className='space-y-6'>
            <div className='space-y-4'>
              <h1 className='text-3xl md:text-5xl text-[#2b364a] leading-tight'>
                Capacite-se para o futuro da docência com
                <span className='text-[#21a3a3] block'>Inteligência Artificial</span>
              </h1>
              <p className='text-lg md:text-xl text-gray-700 leading-relaxed'>
                Desenvolva competências essenciais para integrar ferramentas de Inteligência Artificial ao ensino superior. Aprenda a planejar aulas, criar materiais didáticos, otimizar atividades acadêmicas e potencializar a aprendizagem dos estudantes por meio de aplicações práticas e acessíveis.
              </p>
            </div>
